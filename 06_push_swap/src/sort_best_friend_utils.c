...
/*   Updated: 2023/06/13 19:44:14 by astein           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	ttb = to top stack b
*/
static long	ttb(t_stacks *stacks, unsigned int b, t_bool do_it, t_bool print)
{
	t_stacks	*stacks_cpy;
	long		buf[3];
...
/*
	...
	tta = to top stack b
*/
static long	tta(t_stacks *stacks, unsigned int a, t_bool do_it, t_bool print)
{
	t_stacks	*stacks_cpy;
	long		buf[3];
